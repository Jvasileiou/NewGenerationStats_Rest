...
public class FieldFragment extends Fragment {
    ...
    private boolean inCountStats  = true;
    ...
    private void addClickOnButtons() {
        imgViewPoint00.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                if (inCountStats) ((CountStatsActivity)getActivity()).setLocation("00");
        ...
        imgViewPoint01.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                if (inCountStats) ((CountStatsActivity)getActivity()).setLocation("01");
                selectedImg.setBackgroundResource(R.drawable.buttons_field);
        ...
        imgViewPoint02.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                if (inCountStats) ((CountStatsActivity)getActivity()).setLocation("02");
                selectedImg.setBackgroundResource(R.drawable.buttons_field);
        ...
        imgViewPoint03.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                if (inCountStats) ((CountStatsActivity)getActivity()).setLocation("03");
                selectedImg.setBackgroundResource(R.drawable.buttons_field);
        ...
        imgViewPoint04.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                if (inCountStats) ((CountStatsActivity)getActivity()).setLocation("04");
                selectedImg.setBackgroundResource(R.drawable.buttons_field);
        ...
        imgViewPoint05.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                if (inCountStats) ((CountStatsActivity)getActivity()).setLocation("05");
                selectedImg.setBackgroundResource(R.drawable.buttons_field);
        ...
        imgViewPoint10.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                if (inCountStats) ((CountStatsActivity)getActivity()).setLocation("10");
                selectedImg.setBackgroundResource(R.drawable.buttons_field);
        ...
        imgViewPoint11.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                if (inCountStats) ((CountStatsActivity)getActivity()).setLocation("11");
                selectedImg.setBackgroundResource(R.drawable.buttons_field);
        ...
        imgViewPoint12.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                if (inCountStats) ((CountStatsActivity)getActivity()).setLocation("12");
                selectedImg.setBackgroundResource(R.drawable.buttons_field);
        ...
        imgViewPoint13.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                if (inCountStats) ((CountStatsActivity)getActivity()).setLocation("13");
                selectedImg.setBackgroundResource(R.drawable.buttons_field);
        ...
        imgViewPoint14.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                if (inCountStats) ((CountStatsActivity)getActivity()).setLocation("14");
                selectedImg.setBackgroundResource(R.drawable.buttons_field);
        ...
        imgViewPoint15.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                if (inCountStats) ((CountStatsActivity)getActivity()).setLocation("15");
                selectedImg.setBackgroundResource(R.drawable.buttons_field);
        ...
        imgViewPoint20.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                if (inCountStats) ((CountStatsActivity)getActivity()).setLocation("20");
                selectedImg.setBackgroundResource(R.drawable.buttons_field);
        ...
        imgViewPoint21.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                if (inCountStats) ((CountStatsActivity)getActivity()).setLocation("21");
                selectedImg.setBackgroundResource(R.drawable.buttons_field);
        ...
        imgViewPoint22.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                if (inCountStats) ((CountStatsActivity)getActivity()).setLocation("22");
                selectedImg.setBackgroundResource(R.drawable.buttons_field);
        ...
        imgViewPoint23.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                if (inCountStats) ((CountStatsActivity)getActivity()).setLocation("23");
                selectedImg.setBackgroundResource(R.drawable.buttons_field);
        ...
        imgViewPoint24.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                if (inCountStats) ((CountStatsActivity)getActivity()).setLocation("24");
                selectedImg.setBackgroundResource(R.drawable.buttons_field);
        ...
        imgViewPoint25.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                if (inCountStats) ((CountStatsActivity)getActivity()).setLocation("25");
                selectedImg.setBackgroundResource(R.drawable.buttons_field);
        ...
        imgViewPoint26.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                if (inCountStats) ((CountStatsActivity)getActivity()).setLocation("26");
                selectedImg.setBackgroundResource(R.drawable.buttons_field);
        ...
        imgViewPoint27.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                if (inCountStats) ((CountStatsActivity)getActivity()).setLocation("27");
                selectedImg.setBackgroundResource(R.drawable.buttons_field);
        ...
        imgViewPoint30.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                if (inCountStats) ((CountStatsActivity)getActivity()).setLocation("30");
                selectedImg.setBackgroundResource(R.drawable.buttons_field);
        ...
        imgViewPoint31.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                if (inCountStats) ((CountStatsActivity)getActivity()).setLocation("31");
                selectedImg.setBackgroundResource(R.drawable.buttons_field);
        ...
        imgViewPoint32.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                if (inCountStats) ((CountStatsActivity)getActivity()).setLocation("32");
                selectedImg.setBackgroundResource(R.drawable.buttons_field);
        ...
        imgViewPoint33.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                if (inCountStats) ((CountStatsActivity)getActivity()).setLocation("33");
                selectedImg.setBackgroundResource(R.drawable.buttons_field);
        ...
        imgViewPoint34.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                if (inCountStats) ((CountStatsActivity)getActivity()).setLocation("34");
                selectedImg.setBackgroundResource(R.drawable.buttons_field);
        ...
        imgViewPoint35.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                if (inCountStats) ((CountStatsActivity)getActivity()).setLocation("35");
                selectedImg.setBackgroundResource(R.drawable.buttons_field);
        ...
        imgViewPoint40.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                if (inCountStats) ((CountStatsActivity)getActivity()).setLocation("40");
                selectedImg.setBackgroundResource(R.drawable.buttons_field);
        ...
        imgViewPoint41.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                if (inCountStats) ((CountStatsActivity)getActivity()).setLocation("41");
                selectedImg.setBackgroundResource(R.drawable.buttons_field);
        ...
        imgViewPoint42.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                if (inCountStats) ((CountStatsActivity)getActivity()).setLocation("42");
                selectedImg.setBackgroundResource(R.drawable.buttons_field);
        ...
        imgViewPoint43.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                if (inCountStats) ((CountStatsActivity)getActivity()).setLocation("43");
                selectedImg.setBackgroundResource(R.drawable.buttons_field);
        ...
        imgViewPoint44.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                if (inCountStats) ((CountStatsActivity)getActivity()).setLocation("44");
                selectedImg.setBackgroundResource(R.drawable.buttons_field);
        ...
        imgViewPoint45.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                if (inCountStats) ((CountStatsActivity)getActivity()).setLocation("45");
                selectedImg.setBackgroundResource(R.drawable.buttons_field);
    ...
    public void setInCountStats(boolean inCountStats){
        this.inCountStats = inCountStats;
    }
